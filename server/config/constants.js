export const SUPPORTED_ASSETS = (process.env.SUPPORTED_ASSETS || 'BTCUSDT,ETHUSDT,BNBUSDT,SOLUSDT,XRPUSDT,DOGEUSDT,ADAUSDT,LINKUSDT,1000SHIBUSDT,1000PEPEUSDT,WIFUSDT,1000FLOKIUSDT,1000BONKUSDT,AVAXUSDT,DOTUSDT,POLUSDT,LTCUSDT,BOMEUSDT,PEOPLEUSDT')
  .split(',')
  .map((s) => s.trim());
