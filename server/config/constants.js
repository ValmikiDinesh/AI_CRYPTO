// ─── Supported Assets ────────────────────────────────────────────
export const SUPPORTED_ASSETS = (process.env.SUPPORTED_ASSETS || 'BTCUSDT,ETHUSDT,BNBUSDT,SOLUSDT,XRPUSDT,DOGEUSDT,ADAUSDT,LINKUSDT,SHIBUSDT,PEPEUSDT,WIFUSDT,FLOKIUSDT,BONKUSDT')
  .split(',')
  .map((s) => s.trim());
